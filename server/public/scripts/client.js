...
function handleReady() {
    ...
    $('.historySec').on('click', '#deleteHistory', deleteRequest);
...
function checkEquals() {
    ...
    // makes sure two keys exist (a number and operand)      makes sure there are numbers after the operand
...
function clearButton() {
    console.log('Clicked');
    // clear input, reset both numString variable and currentCalculation object, and remove error messages
    $('input').val('');
    numString = '';
    currentCalculation = {};
    $('#errorSection').empty();
...
function historyRequest() {
    ...
    $.ajax({
        ...
        response.forEach(calc => {
            ...
            // append the history display to DOM, storing data for use during on-click recalculations
            el.append(`
        ...
        // append delete button at the bottom of the history list
        el.append(`
...
function deleteRequest() {
    ...
    $.ajax({
        ...
        success: (function (response) {
            ...
            // refresh the Result display and run historyRequest to update DOM
            $('#resultSection').empty();
...
// populates an error message depending on the circumstances of the error
...
// handles repeating previous calculations when clicking on history
